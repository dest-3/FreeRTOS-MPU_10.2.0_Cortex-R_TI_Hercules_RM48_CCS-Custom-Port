...
static void prvSetupTimerInterrupt(void)
{
    ...
    /* Disable all RTI timers. */
      portRTI_GCTRL_REG &= 0xFFFFFFFCUL;

      /* Use the internal counter. */
      portRTI_TBCTRL_REG = 0x00000000U;

      /* COMPSEL0 will use RTIFRC0 counter. */
      portRTI_COMPCTRL_REG = 0x00000000U;

      /* Initialise the counter and prescale counter registers for Timer 0. */
      portRTI_CNT0_UC0_REG  = 0x00000000U;
      portRTI_CNT0_FRC0_REG = 0x00000000U;

      /* Set prescaler and comparison values for Timer 0 (1ms intervals). */
      portRTI_CNT0_CPUC0_REG = 0x00000001U;
      portRTI_CNT0_COMP0_REG = (configCPU_CLOCK_HZ / 2) / configTICK_RATE_HZ;
      portRTI_CNT0_UDCP0_REG = (configCPU_CLOCK_HZ / 2) / configTICK_RATE_HZ;

      /* Clear pending interrupts for Timer 0 and enable Compare 0 interrupt. */
      portRTI_INTFLAG_REG = 0x00000001U; // Clear Compare 0 interrupt
      portRTI_CLEARINTENA_REG = 0x00000001U;
      portRTI_SETINTENA_REG = 0x00000001U;

      portRTI_COMPCTRL_REG = 0x00000010U;
      ...
      /* Clear pending interrupts for Timer 1 and enable Compare 1 interrupt. */
      portRTI_INTFLAG_REG = 0x00000002U; // Clear Compare 1 interrupt
      portRTI_CLEARINTENA_REG = 0x00000002U;
      portRTI_SETINTENA_REG = 0x00000002U;

      /* Enable RTI timers. */
      portRTI_GCTRL_REG |= 0x00000001U; // Enable both timers
